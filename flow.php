...
<body class="hold-transition skin-blue layout-top-nav">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                          <li><a href="
                            ...
                            <li ><a href="#" class="dropdown-toggle" data-toggle="dropdown"><strong><i class="fa fa-road" aria-hidden="true"></i>&nbsp;Redress Process</strong> <span class="caret"></span></a></li>
  ...
  <div class="box box-info">
      <div class="box-header with-border">
          <h3 class="box-title text-blue">Grievance Redress Flow</h3>
      </div>
      <div class="box-body">
          <div class="row">
              <div class="col-md-10 pull-right">
                <!-- <div class="col-md-8"></div> -->
                <img class="flow center " src="./Images/flow.png"  alt="Redressal Flow " >
